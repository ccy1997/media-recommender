...
def submit():
    ...
    movie_recommendation = r.generate_k_recommendations(Media.MOVIE, 10)
    game_recommendation = r.generate_k_recommendations(Media.GAME, 10)
    book_recommendation = r.generate_k_recommendations(Media.BOOK, 10)
